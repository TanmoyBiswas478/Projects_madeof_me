                        ...
                        <table class="table table-bordered" style="font-size: 11.5px;">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Unit</th>
                                    <th class="text-center">No of Pc</th>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" ng-model="unit" ng-change="unitview()">
                                        <option>Case</option>
                                        <option>Dojon</option>
                                        <option>PC</option>
                                        <option>Nos</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1">No of Pc</label>
                                <div class="input-group">
                                    <input type="text" ng-model="nop" id="nop" class='form-control' onkeypress="return isNumber(event)">
