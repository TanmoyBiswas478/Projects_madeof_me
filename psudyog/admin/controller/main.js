...
app.config(function ($routeProvider) {
    ...
    $routeProvider
        ...
        .when('/franchise', {
            templateUrl: 'pages/franchise.html',
            controller: 'dashCtrl'
        })
        .when('/shop', {
        ...
        .when('/approval', {
            templateUrl: 'pages/view_approval.html',
            controller: 'dashCtrl'
        })
...
app.controller('dashCtrl', function ($scope, $http) {
    ...
    $scope.calc = function () {
        var x=$scope.plan;
        var y=parseInt(x)*250;
        $scope.paid=y;
    }

    //Role Entry Section
    $scope.franentry = function () {
        $http({
            url: "../assets/api/fran_section.php",
            method: "POST",
            data: {
                "fname": $scope.fname,
    ...
    $scope.ratecalc = function () {
        var x = $scope.qty;
        var y = $scope.rate;
        $scope.tax = parseFloat(x) * parseFloat(y);
    }
