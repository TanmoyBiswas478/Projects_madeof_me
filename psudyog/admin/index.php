          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="#!/franchise"><i class="fas fa-angle-double-right"></i> Franchising Entry</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/shop"><i class="fas fa-angle-double-right"></i> Shop Entry</a>
                <!-- <div class="dropdown-divider"></div>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="#!/approval"><i class="fas fa-angle-double-right"></i> View Approval</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/req"><i class="fas fa-angle-double-right"></i> View Payment</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/staff"><i class="fas fa-angle-double-right"></i> Required Payment</a>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="#!/purchaserep"><i class="fas fa-angle-double-right"></i> Todays Collection</a>
                <!-- <div class="dropdown-divider"></div>
