...
<html lang="en">
  ...
  <body ng-app="myApp">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">Easy GST</a>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="#!/stype"><i class="fas fa-angle-double-right"></i> Service Type Entry</a>
                <!-- <div class="dropdown-divider"></div>
                ...
                <div class="dropdown-divider"></div>
                <!-- <a class="dropdown-item" href="#!/client"><i class="fas fa-angle-double-right"></i> Client Entry</a>
                <div class="dropdown-divider"></div> -->
                <a class="dropdown-item" href="#!/company"><i class="fas fa-angle-double-right"></i> Company Entry</a>
                <div class="dropdown-divider"></div> 
                <a class="dropdown-item" href="#!/sreq"><i class="fas fa-angle-double-right"></i> Generate Service Request</a>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <!-- <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/bill"><i class="fas fa-angle-double-right"></i> Bill Entry</a> -->
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/works"><i class="fas fa-angle-double-right"></i> Works Assign</a> 
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/bill"><i class="fas fa-angle-double-right"></i> Stock Return</a>
                <!-- <div class="dropdown-divider"></div>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="#!/tc"><i class="fas fa-angle-double-right"></i> Todays Collection</a>
                 <div class="dropdown-divider"></div>
                ...
                <!-- <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/vendor_ledger"><i class="fas fa-angle-double-right"></i> Customer Ledger</a> -->
              </div>
            </li>

            <li class="nav-item">
             <a class="nav-link" href="#!/cp"> <i class="fas fa-key"></i> Change Password</a>
            </li>
...
<div class="ml-auto">
    <span class="navbar-text text-light"><i class="fas fa-user-md"></i> <?php echo $_SESSION['sname']; ?></span> <!-- Replace this with PHP code if needed -->
  </div>
