...
{
 unset($data1['op']);
 $obj->insert_db('work_order', $data1);
}
...
else if($op=='edit')
{
 ...
 $where = "id =".$data1['id'];
 unset($data1['idd']);
 $obj->update_db('work_order', $data1,$where);
}
...
{
 unset($data1['op']);
 $obj->delete_db('work_order', $data1);
}
...
else if($op=='select_condition')
{
 ...
 $where = "id =".$data1['idd'];
 unset($data1['idd']);
 $obj->select_db('work_order', $data1,$where);
}
?>