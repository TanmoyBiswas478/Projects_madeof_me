    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
          ...
          if (!empty($row['submenue'])) {
            ...
            if (mysqli_num_rows($res1) > 0) {
              ...
              while ($row1 = mysqli_fetch_assoc($res1)) {
                echo "<a class='dropdown-item' href=pages/" . $row1['url'] . ">" . $row1['submenue'] . "</a>";
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="pages/menu.php">Menue Section</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="pages/permission.php">User Peremission</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="pages/create_user.php">Create Users</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="pages/active_user.php">Active Users</a>
        </div>
      </li>';
        }
        ?>
