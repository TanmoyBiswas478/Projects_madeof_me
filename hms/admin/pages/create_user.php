        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="text-danger"><b>User Create Section</b></h2>
                    <!-- <ol>
                ...
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr class="table-warning text-dark">
                            ...
                            <th class="text-center" style=" text-transform: uppercase;">Phone No</th>
                            <th class="text-center" style=" text-transform: uppercase;">Staff Name</th>
                    ...
                    <tbody>
                        <tr ng-repeat="x in staff_view_data">
                            <td class="text-center">{{$index+1}}</td>
                            <td class="text-center">{{x.ph}}</td>
                            <td class="text-center">{{x.name}}</td>
                            <td class="text-center">{{x.gender}}</td>
                            <td class="text-center">{{x.email}}</td>
                            <td class="text-center">{{x.quali}}</td>
                            <td class="text-center">
                                <button class="btn-success" title="edit" data-toggle="modal"
                                data-target=".bd-example-modal-lg1" ng-click="staff_edit(x.id)"><i class="fa-solid fa-pen-to-square"></i></button>
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <h2 class="text-center">User Entry Section</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" ng-model="ph" maxlength="10"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                        ng-blur="generatePass()" required>
                                    <input type="hidden" ng-model="pass">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput"
                                        style=" text-transform: uppercase;" ng-model="name">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput"
                                        style=" text-transform: uppercase;" ng-model="address">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput"
                                        style="text-transform: capitalize;" ng-model="qualification">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="button" class="btn btn-success" id="myBtn"
                                    ng-click="staffentry()">Submit</button> &nbsp;
