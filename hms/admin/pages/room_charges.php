...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
        ...
        <div style="padding-top: 20px;" ng-init="room_charges_view();ward_view();">
        
            <div class="container">
                <p class="text-right">
                    <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"><i
                            class="fa-solid fa-plus"></i> Add Room Price</button>
                </p>
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr class="table-warning text-dark">
                            <th class="text-center">#</th>
                            <th class="text-center" style=" text-transform: uppercase;">Room/Ward</th>
                    ...
                    <tbody>
                        <tr ng-repeat="x in room_charges_view">
                            ...
                            <td class="text-center">
                                <button class="btn-success" title="Edit" data-toggle="modal"
                                    data-target="#exampleModalCenter" ng-click="room_charges_edit(x.id)"><i
                                        class="fa-solid fa-pen-to-square"></i></button>
                                <button class="btn-danger" title="Delete" ng-click="room_charges_delete(x.id)"><i
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <h2 class="text-center">Room Price Section</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Room / Ward<span
                                            style="color:red; font-size: 8px; vertical-align: text-top;"><i
                                                class="fa-solid fa-star-of-life"></i></span></label>
                                    <select class="form-control" ng-model="w_no">
                                        <option ng-repeat="z in Changeit_data">{{z.w_no}}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Charges<span
                                            style="color:red; font-size: 8px; vertical-align: text-top;"><i
                                                class="fa-solid fa-star-of-life"></i></span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="button" class="btn btn-success" id="myBtn"
                                    ng-click="room_charges_entry()">Submit</button> &nbsp;
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Update Room / Ward</h5>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-dismiss="modal"
                                ng-click="room_charges_update()">Update</button>
                        </div>
                    </div>
                </div>
            </div>
