                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr ng-repeat="x in payment_view_data">
                            ...
                            <td class="text-center" style="text-transform:capitalize;">{{x.payment_name}}</td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" style="text-transform:capitalize;" ng-model="payment_name" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
