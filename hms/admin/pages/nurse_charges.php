...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="nurse_care.php">Nurse Care</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="nurse_charges.php">Charges</a>
                        </div>
                    </li>
        ...
        <div class="container">
            <p class="text-right">
                <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa-solid fa-plus"></i> Add Care Price</button>
            </p>
            <table class="table table-bordered table-striped">
                <thead>
                    <tr class="table-warning text-dark">
                        <th class="text-center">#</th>
                        <th class="text-center" style=" text-transform: uppercase;">Nurse Care Type</th>
                ...
                <tbody>
                    <tr ng-repeat="x in unit_name_view">
                        ...
                        <td class="text-center">
                            <button class="btn-success" title="Edit" data-toggle="modal" data-target="#exampleModalCenter" ng-click="unit_name_edit(x.id)"><i class="fa-solid fa-pen-to-square"></i></button>
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <h2 class="text-center">Nurse Care Price Section</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="formGroupExampleInput">Nurse Care</label>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Nurse Care</h5>
