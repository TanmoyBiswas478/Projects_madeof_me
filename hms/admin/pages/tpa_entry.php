                ...
                <table class="table table-bordered">
                    <thead>
                        <tr class="table-info text-dark">
                            ...
                            <th class="text-center">TPA Name</th>
                    ...
                    <tbody>
                        <tr ng-repeat="x in tpa_view_data">
                            ...
                            <td class="text-center" style="text-transform:uppercase;">{{x.code}}</td>
                            <td class="text-center">{{x.phone}}</td>
                            <td class="text-center" style="text-transform:capitalize;">{{x.address}}</td>
                            <td class="text-center" style="text-transform:capitalize;">{{x.contact_prsn_nme}}</td>
                            <td class="text-center" style="text-transform:capitalize;">{{x.contact_prsn_ph}}</td>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" type="text" id="exampleFormControlTextarea1"
                                        ng-model="address" style=" text-transform:capitalize;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" ng-model="contact_prsn_nme" style=" text-transform:capitalize;" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput"
                                         maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" ng-model="contact_prsn_ph">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Contact person name</label>
                                    <input type="text" class="form-control" style=" text-transform:capitalize;" ng-model="contact_prsn_nme" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
