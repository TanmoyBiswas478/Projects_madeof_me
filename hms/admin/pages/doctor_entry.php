        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="text-danger"><b>Doctor Create Section</b></h2>
                    <!-- <ol>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr ng-repeat="x in doctor_view_data">
                            ...
                            <td class="text-center">{{x.regis_no}}</td>
                            <td class="text-center">{{x.name}}</td>
                            <td class="text-center">{{x.mobile}}</td>
                            <td class="text-center">{{x.email}}</td>
                            <td class="text-center">{{x.qulification}}</td>
                            <td class="text-center">{{x.specialization}}</td>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput" ng-model="regis_no" required>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Doctor Name</label>
                                    <input type="text" class="form-control" style="text-transform: uppercase;" ng-model="name" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" ng-model="doctoraddress" style="text-transform: capitalize;"></textarea required>
                        </div>
                    </div>
                </div>
