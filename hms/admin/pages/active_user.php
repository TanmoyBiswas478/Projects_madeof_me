        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="text-danger"><b>Permission Section</b></h2>
                    <ol>
                        <!-- <li><a href="#"><button class="btn btn-danger"><i class="fa-solid fa-arrow-left"></i> Back</button></a>
                </li> -->
                    </ol>
                </div>
            </div>
        </section><!-- End Breadcrumbs Section -->
        <div style="padding-top: 20px;" ng-init="astaffview()">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered text-center">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="x in user_active_data">
                                            <th>{{$index+1}}</th>
                                            <td style="width:20%;">
                                                {{x.user}}</td>
                                            <td style="text-transform: capitalize; width:20%;">
                                                {{x.name}}
                                            </td>
                                            
                                            <td>
                                                <button class="btn-danger" title="Delete"
                                                    ng-click="deactive(x.id)"><i
                                                        class="fa-sharp fa-solid fa-trash"></i> Deactive</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
