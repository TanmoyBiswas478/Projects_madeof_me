                ...
                <div class="card-header text-white bg-info">
                    <div class="d-flex">
                        ...
                        <div class="p-2">
                            ...
                            <button class="btn text-dark" data-toggle="modal" ng-show="var" ng-click="patient_entry();"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" maxlength="10"
                                    ...
                                    name="mobile" ng-model="mobile" ng-blur="old_number_search()" Required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" style="text-transform: capitalize;" name="city"
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" style="text-transform: capitalize;" name="state"
                    ...
                    <div class="row" style="padding-top:8px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" style="text-transform: lowercase;" name="email"
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><i class="fa-solid fa-id-card-clip"></i> ID
                                    Type</label>
                                <select type="text" class="form-control" ng-model="n_id_type" name="n_id_type" required>
                                    <option></option>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <button type="button" class="btn btn-success" id="myBtn"
                                ng-click="general_regis()">Submit</button> &nbsp;
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleInputEmail1"><i class="fa-solid fa-id-badge"></i> Patient
                                ID</label>
                            <input type="text" class="form-control" name="patient_id" ng-model="patient_id"
                            ng-blur="old_patient_view();" readonly>
                        </div>
                    </div>
                </div>
                <!-- Patient Details section -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleInputEmail1"><i class="fa-solid fa-address-card"></i>
                                Address</label>
                            <input type="text" class="form-control" style="text-transform: capitalize;" name="address"
