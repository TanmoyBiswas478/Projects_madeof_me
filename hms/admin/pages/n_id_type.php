...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="text-danger"><b>National ID Create Section</b></h2>
                    <!-- <ol>
        ...
        <div style="padding-top: 20px;" ng-init="nation_view()">
            ...
            <div class="container">
                <p class="text-right">
                    <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"><i
                            class="fa-solid fa-plus"></i> Add National ID</button>
                </p>
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr class="table-warning text-dark">
                            <th class="text-center">#</th>
                            <th class="text-center" style=" text-transform: uppercase;">National ID Type</th>
                    ...
                    <tbody>
                        <tr ng-repeat="x in nation_view_data">
                            ...
                            <td class="text-center">{{x.n_id_type}}</td>
                            <td class="text-center">
                                <button class="btn-success" title="edit" data-toggle="modal"
                                    data-target="#exampleModalCenter" ng-click="n_id_type_edit(x.id)"><i
                                        class="fa-solid fa-pen-to-square"></i></button>
                                <button class="btn-danger" title="Delete" ng-click="n_id_type_delete(x.id)"><i
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">National ID Type</label>
                                    <input type="text" class="form-control" ng-model="n_id_type" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">National ID Type Update Section</h5>
