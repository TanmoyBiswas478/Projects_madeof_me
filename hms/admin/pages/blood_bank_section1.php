...
<html lang="en">
   ...
   <body>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" ng-model="product_type" id="textInput"
                                 required>
                           </div>
                        </div>
                     </div>
               ...
               <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                     <tr ng-repeat="x in product_view_data">
                        ...
                        <td class="text-center">
                           <button class="btn-success" title="Edit" data-toggle="modal"
                              data-target="#exampleModalCenter" ng-click="product_edit(x.id)"><i
                              class="fa-solid fa-pen-to-square"></i></button>
                  ...
                  <div class="container" style="padding-bottom: 20px !important;">
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              <label for="formGroupExampleInput">Product Type</label>
                              <Select type="text" class="form-control" ng-model="product_type" id="textInput"
                                 required>
                                 <option></option>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" ng-model="product_name" id="textInput"
                                 required>
                           </div>
                        </div>
                     </div>
      ...
      <div id="Donor" class="tabcontent">
            ...
            <div class="container">
               <p class="text-right">
                  <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg3"><i
                     class="fa-solid fa-plus"></i> Add Blood Donor</button>
               </p>
               <table class="table table-bordered table-striped">
                  <thead>
                     <tr class="table-warning text-dark">
                        <th class="text-center">#</th>
                        <th class="text-center">Donar Name</th>
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" ng-model="donor_name" style=" text-transform: uppercase;">
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" ng-model="ph"
                                 style=" text-transform: uppercase;">
                           </div>
                        </div>
                     </div>
         ...
         <!-- Update model section -->
         <div class="modal fade bd-example-modal-lg3" id="exampleModalCenter1" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
               <div class="modal-content">
                  <div class="modal-header">
