...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
        ...
        <section class="breadcrumbs" style="padding : 20px !important;"
            ng-init="app_admit_view();symptom_head_view();bed_type_view();bed_view();ward_view();patient_view();dept_view();symptom_view();tpa_view();doctor_view();patient_old();general_view();payment_view();lab_dept_view();lab_test_view();">
            <div class="">
                <div class="card-header text-white bg-info">
                    <div class="d-flex">
                        <div class="mr-auto p-2" style="font-size:20px;"><b>Pathology Section</b></div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="padding-top:8px;">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><i class="fa-solid fa-location-dot"></i>
                                    Location</label>
                                <input class="form-control" ng-model="location" readonly>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><i class="fa-solid fa-user-doctor"></i> Registered
                                    Type</label>
                                <input type="text" class="form-control" style="text-transform: capitalize;"
                                    ng-model="regis_type" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12" style="font-size:20px;">
                            <b><i class="fa-solid fa-database"></i> Other
                                Details</b><br>
                            <Div style="border: none; height: 2px; color: #333; background-color: #333;">
                                <hr>
                            </Div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><i class="fa-solid fa-id-card-clip"></i> ID
                                    Type</label>
                                <input type="text" class="form-control" ng-model="n_id_type" readonly>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><i class="fa-solid fa-id-card-clip"></i> ID
                                    No</label>
                                <input type="text" class="form-control" ng-model="nid" readonly>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><i class="fa-solid fa-infinity"></i> Marital
                                    Status</label>
                                <input class="form-control" ng-model="marital" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group mb-3">
                                    <select class="custom-select" ng-model="lab_dept" ng-blur="lab_dept_search()">
                                        <option></option>
                            ...
                            <td>
                                <div class="input-group mb-3">
                                    ...
                                    <option></option>
                                        <option ng-repeat="n in lab_test_data">{{n.test}}</option>
                                    </select>
                                </div>
                            </td>
                            <td>
                            ...
                            <!-- upto this -->
                            <td class="text-center" d-grid><button type="button" class="btn btn-success "><i
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="exampleInputPassword1">Amount Recive</label>
                            <input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="exampleInputPassword1">Discount Remarks</label>
                            <input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="exampleInputPassword1">Discount Authorized</label>
                            <select type="text" class="form-control">
                                <option></option>
                            </select>
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="exampleInputPassword1">Payment Due</label>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <button type="button" class="btn btn-success" id="myBtn">Bill Now</button> &nbsp;
    ...
    $(document).ready(function() {
        ...
        $(".add_item_btn").click(function(e) {
            ...
            $("#add_form").prepend(
                ...
                '<td>' +
                '<div class="input-group mb-3">' +
                '<select class="custom-select" name="reg_type[]">' +
                '<option></option>' +
                '<option>OPD</option>' +
                '<option>IPD</option>' +
                '</select>' +
                ...
                '<td>' +
                '<div class="input-group mb-3">' +
                '<select class="custom-select" name="data1[]">' +
                '<option></option>' +
                '</select>' +
                '</div>' +
                '</td>' +
                '<td>' +
                '<div class="input-group mb-3">' +
                '<select class="custom-select" name="data2[]">' +
                '<option>1</option>' +
                '<option>2</option>' +
                '<option>3</option>' +
                '<option>5</option>' +
                ...
                '</div>' +
                '</td>' +
                '<td class="text-center" d-grid><button type="button" class="btn btn-danger remove_item_btn"><i class="fa-solid fa-trash"></i></button></td>' +
                '</tr>'
            );
        });

        // Function to remove items
        $("#add_form").on("click", ".remove_item_btn", function() {
