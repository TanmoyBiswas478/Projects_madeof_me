...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="text-danger"><b>Qualification</b></h3>
                    <!-- <ol>
        ...
        <div style="padding-top: 20px;" ng-init="qualification_view()">
            <div class="container">
                <p class="text-right">
                    <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg6"><i
                            class="fa-solid fa-plus"></i> Add Qualification</button>
                </p>
                        ...
                        <tr ng-repeat="x in qualification_view_data">
                            ...
                            <td class="text-center">
                                <button class="btn-success" title="edit" data-toggle="modal"
                                    data-target="#exampleModalCenter" ng-click="qualification_edit(x.id)"><i
                                        class="fa-solid fa-pen-to-square"></i></button>
                                <button class="btn-danger" title="Delete" ng-click="qualification_delete(x.id)"><i
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="button" class="btn btn-success" id="myBtn"
                                    ng-click="qualification_entry()">Submit</button>
                                &nbsp;
        ...
        <div class="modal fade bd-example-modal-lg6" id="exampleModalCenter" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal"
                            ng-click="qualification_update()">Update</button>
                    </div>
                </div>
            </div>
        </div>
