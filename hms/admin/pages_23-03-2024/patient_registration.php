                            ...
                            <div class="col-md-3" ng-show="patient_type === 'old'">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><i class="fa-solid fa-id-badge"></i> Patient
                                        ID</label>
                                    <input type="text" class="form-control" name="patient_id" ng-model="patient_id" ng-blur="old_patient_view();old_view()">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" style="text-transform: capitalize;"
                                        name="referral_doctor" ng-model="referral_doctor" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><i class="fa-solid fa-user"></i> Patient
                                        Name</label>
                                    <input type="text" class="form-control" ng-model="patient_name" style="text-transform: uppercase;"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><i class="fa-solid fa-person-breastfeeding"></i>
                                        Father
                                        Name</label>
                                    <input type="text" class="form-control" ng-model="father_name" style="text-transform: capitalize;"
