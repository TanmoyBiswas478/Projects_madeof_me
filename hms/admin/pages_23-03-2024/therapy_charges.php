...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="text-danger"><b>Therapies Service</b></h2>
                    <!-- <ol>
        ...
        <div style="padding-top: 20px;" ng-init="therapy_charges_view()">
            <div class="container">
                <p class="text-right">
                    <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"><i
                            class="fa-solid fa-plus"></i> Add Therapy Price</button>
                </p>
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr class="table-warning text-dark">
                            <th class="text-center">#</th>
                            <th class="text-center" style=" text-transform: uppercase;">Therapies Type</th>
                    ...
                    <tbody>
                        <tr ng-repeat="x in therapy_charges_view_data">
                            <td class="text-center">{{$index+1}}</td>
                            <td class="text-center">{{x.therapies_type}}</td>
                            <td class="text-center">{{x.charge}}</td>
                            <td class="text-center">
                                <button class="btn-success" title="Edit" data-toggle="modal"
                                    data-target="#exampleModalCenter" ng-click="therapy_charges_edit(x.id)"><i
                                        class="fa-solid fa-pen-to-square"></i></button>
                                <button class="btn-danger" title="Delete" ng-click="therapy_charges_delete(x.id)"><i
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <h2 class="text-center">Therapy Price Section</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Therapy Type</label>
                                    <select class="form-control" ng-model="therapies_type">
                                        <option></option>
                                        <option>Physical Therapy</option>
                                        <option>Occupational Therapy</option>
                                        <option>Speech Therapy</option>
                                        <option>Respiration Therapy</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="button" class="btn btn-success" id="myBtn"
                                    ng-click="therapy_charges_entry()">Submit</button> &nbsp;
                        ...
                        <div class="container" style="padding-bottom: 20px !important;">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" data-dismiss="modal"
                                    ng-click="therapy_charges_update()">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
