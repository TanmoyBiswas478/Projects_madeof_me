...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
        ...
        <!-- ======= Breadcrumbs Section ======= -->
        <section class="breadcrumbs" style="padding : 20px !important;" ng-init="app_view();nurse_view_admit();">
            <div class="card" ng-init="patient_view();">
                ...
                <form action="../../assets/api/nurse_patient_entry.php" method="post" enctype="multipart/form-data">
                    <div class="card-body" ng-show="var1">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1"><i class="fa-solid fa-up-long"></i>
                                        Height (cm)</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" name="height" maxlength="3"
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1"><i class="fa-solid fa-weight-scale"></i>
                                        Weight (kg)</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" name="weight" maxlength="3"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1" name="bp" maxlength="3"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1"><i class="fa-solid fa-heart-pulse"></i>
                                        Pulse</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" name="pulse" maxlength="3"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                </div>
                            </div>
                            <div class="col-lg-2">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn btn-success" id="myBtn">Accept</button> &nbsp;
            ...
            <div class="card-body" ng-show="var">
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        <tr ng-repeat="x in nurse_view_data">
                            <th>{{$index+1}}</th>
                            <td>{{x.patient_id}}</td>
