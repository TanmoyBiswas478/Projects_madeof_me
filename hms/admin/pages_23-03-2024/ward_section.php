...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="text-danger"><b>Ward Section</b></h2>
                    <!-- <ol>
        ...
        <div style="padding-top: 20px;" ng-init="ward_view();dept_view();floor_view()">
            <div class="container">
                <p class="text-right">
                    <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa-solid fa-plus"></i> Add Ward</button>
                </p>
                    ...
                    <tbody>
                        <tr ng-repeat="x in ward_view_data">
                            ...
                            <td class="text-center">
                                <button class="btn-success" title="edit" data-toggle="modal" data-target="#exampleModalCenter" ng-click="ward_edit(x.id)"><i class="fa-solid fa-pen-to-square"></i></button>
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" ng-init="dept_view();floor_view();">
        ...
        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" ng-init="dept_view();floor_view()">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" data-dismiss="modal" ng-click="ward_update()">Update</button>
                        </div>
                    </div>
                </div>
            </div>
