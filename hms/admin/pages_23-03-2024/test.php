        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <h2 class="text-center">Surgical Service Charge</h2>
                    <div class="container" style="padding-bottom: 20px !important;">

                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Surgical Service Types</label>
                                    <select type="text" class="form-control" ng-model="" required>
                                    <option></option>
                                        <option>Operating Room</option>
                                        <option>Surgoens's</option>
                                        <option>Anaesthesiologist's</option>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Update Surgical Service</h5>
