...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
        ...
        <section class="breadcrumbs" style="padding : 20px !important;"
            ng-init="app_admit_view();patient_view();dept_view();symptom_view();tpa_view();doctor_view();patient_old();general_view();payment_view()">
            <div class="card">
                <div class="card-header text-white bg-info">
                    <div class="d-flex">
                        <div class="mr-auto p-2" style="font-size:20px;"><b>Patient Admit Section</b></div>
                        <div class="p-2">
                ...
                <div class="card-body" ng-show="var1">
                    <form method="post" action="../../assets/api/patient_admit_section.php"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><i class="fa-solid fa-location-dot"></i>
                                        Location</label>
                                    <input class="form-control" name="location" ng-model="location" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="10"
                                        ...
                                        name="mobile" ng-model="mobile" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" style="text-transform: capitalize;"
                                        name="referral_doctor" ng-model="referral_doctor" readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" style="text-transform: uppercase;"
                                        name="patient_name" ng-model="patient_name" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><i class="fa-solid fa-person-breastfeeding"></i>
                                        ...
                                        Name</label>
                                    <input type="text" class="form-control" style="text-transform: capitalize;"
                                        name="father_name" ng-model="father_name" readonly>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="3"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                        name="age" ng-model="age" readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><i class="fa-solid fa-address-card"></i>
                                        Address</label>
                                    <input type="text" class="form-control" style="text-transform: capitalize;"
                                        name="address" ng-model="address" readonly>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" style="text-transform: capitalize;"
                                        name="city" ng-model="city" readonly>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" style="text-transform: capitalize;"
                                        name="state" ng-model="state" readonly>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="6"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                        name="pin" ng-model="pin" readonly>
                                </div>
                            </div>
                        </div>
                        <!-- Other Section -->
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><i class="fa-solid fa-id-card-clip"></i> ID
                                        Type</label>
                                    <input type="text" class="form-control" name="n_id_type" ng-model="n_id_type"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><i class="fa-solid fa-id-card-clip"></i> ID
                                        No</label>
                                    <input type="text" class="form-control" name="nid" ng-model="nid" readonly>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><i class="fa-solid fa-infinity"></i> Marital
                                        Status</label>
                                    <input class="form-control" name="marital" ng-model="marital" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12" style="font-size:20px;"><b><i
                                        class="fa-solid fa-hands-holding-child"></i> Guardian
                                    Details</b><br>
                                <Div style="border: none; height: 2px; color: #333; background-color: #333;">
                                    <hr>
                                </Div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><i class="fa-solid fa-address-card"></i> Guardian
                                        Mobile</label>
                                    <input type="text" class="form-control" style="text-transform: capitalize;"
                                        name="gar_mobile" maxlength="10"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12" style="font-size:20px;"><b><i class="fa-solid fa-building"></i>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control" name="bed_type" ng-model="bed_type"
                                        ...
                                        <option></option>
                                        <option ng-repeat="b in btdata">{{b.bed_type}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control" name="bed_no">
                                        <option></option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><i class="fa-solid fa-truck-medical"></i>
                                        Payment Mode</label>
                                    <select type="text" class="form-control" name="tpa">
                                        <option></option>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1"><i class="fa-solid fa-user-doctor"></i>
                                        Primary Consult Name</label>
                                    <select class="form-control" id="exampleFormControlSelect1"
                                        style="text-transform: capitalize;" name="consult_doctor">
                                        <option></option>
                                        <option ng-repeat="d in doctor_view_data">{{d.name}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1"><i class="fa-solid fa-disease"></i> Symptoms
                                        Title</label>
                                    <select class="form-control" id="exampleFormControlSelect1" name="symptoms_title"
                                        ng-model="symptoms_title">
                                        <option></option>
                                        <option ng-repeat="e in sym_data">{{e.symptoms_title}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" style="text-transform: capitalize;"
                                        id="exampleFormControlTextarea1" name="symptoms_desc"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="card-body" ng-show="var">
                <p class="text-right">
                    ...
                    Search: <input class="" type="text" ng-model="search" placeholder="Search">
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        <tr ng-repeat="a in app_admit_view | filter: search">
                            <th>{{$index+1}}</th>
                            <td>{{a.patient_id}}</td>
                            ...
                            <td class="text-center"><button class="btn-warning" title="Admit" data-toggle="modal"
                                    data-target="#exampleModalCenter" ng-show="var"
                                    ng-click="patient_entry();general_view(a.id)"><i
            ...
            <div class="card-body" ng-show="var2">
                <table class="table table-bordered text-center">
                    <thead class="table-info">
                        <tr>
                            <th width="8%">#</th>
                    ...
                    <tbody>
                        <tr ng-repeat="a in app_admit_view">
                            <th>{{$index+1}}</th>
                            <td>{{a.patient_id}}</td>
                            <td style="text-transform: uppercase;">{{a.patient_name}}</td>
                            <td style="text-transform: capitalize;">{{a.father_name}}</td>
