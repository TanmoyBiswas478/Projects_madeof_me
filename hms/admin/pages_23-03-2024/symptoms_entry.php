        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="text-danger"><b>Patient Symptoms Create Section</b></h2>
                    <!-- <ol>
            ...
            <div class="container">
                <p class="text-right">
                    <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"><i
                            class="fa-solid fa-plus"></i> Add Symptoms</button>
                </p>
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr class="table-warning text-dark">
                            <th class="text-center">#</th>
                            <th class="text-center" style=" text-transform: uppercase;">Symptoms Type</th>
                            <th class="text-center" style=" text-transform: uppercase;">Symptoms Title</th>
                            <th class="text-center" style=" text-transform: uppercase;">Symptoms Description</th>
                    ...
                    <tbody>
                        <tr ng-repeat="x in symptom_view_data">
                            ...
                            <td class="text-center">{{x.symptoms_type}}</td>
                            <td class="text-center">{{x.symptoms_title}}</td>
                            <td class="text-center">{{x.symptoms_description}}</td>
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <h2 class="text-center">Symptoms Entry Section</h2>
                    <div class="container" style="padding-bottom: 20px !important;">

                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Symptoms Type</label>
                                    <input type="text" class="form-control" ng-model="symptoms_type" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Symptoms Title</label>
                                    <input type="text" class="form-control" id="formGroupExampleInput"
                                        style=" text-transform: capitalize;" ng-model="symptoms_title">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Symptoms Description</label>
                                    <textarea class="form-control" type="text" id="exampleFormControlTextarea1"
                                        ng-model="symptoms_description"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Symptoms Title</label>
                                    <input type="text" class="form-control" id="formGroupExampleInput"
                                        style=" text-transform: uppercase;" ng-model="symptoms_title">
                                </div>
                            </div>
                        </div>
                        <div class="row">
