...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="text-danger"><b>Medical Service</b></h2>
                    <!-- <ol>
        ...
        <div style="padding-top: 20px;" ng-init="medical_charges_view()">
            <!-- <h2 class="text-center"><u>Add Section</u></h2> -->
            <div class="container">
                <p class="text-right">
                    <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"><i
                            class="fa-solid fa-plus"></i> Add Medical Service Price</button>
                </p>
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr class="table-warning text-dark">
                            <th class="text-center">#</th>
                            <th class="text-center" style=" text-transform: uppercase;">Medical Service Type</th>
                            <th class="text-center" style=" text-transform: uppercase;">Price</th>
                            <th class="text-center" style=" text-transform: uppercase;">Action</th>
                        </tr>
                    </thead>

                    <tbody>
                        <tr ng-repeat="x in medical_charges_view_data">
                            <td class="text-center">{{$index+1}}</td>
                            <td class="text-center">{{x.m_type}}</td>
                            <td class="text-center">{{x.charge}}</td>
                            <td class="text-center">
                                <button class="btn-success" title="Edit" data-toggle="modal"
                                    data-target="#exampleModalCenter" ng-click="medical_charges_edit(x.id)"><i
                                        class="fa-solid fa-pen-to-square"></i></button>
                                <button class="btn-danger" title="Delete" ng-click="medical_charges_delete(x.id)"><i
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <h2 class="text-center">Medical Price Section</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Medical Service Type</label>
                                    <select class="form-control" ng-model="m_type">
                                        <option></option>
                                        <option>Physician Consulations</option>
                                        <option>Specialist Consulaion</option>
                                        <option>Daily Rounds</option>
                                        <option>Emergency Room Visits</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Charges</label>
                                    <input type="text" class="form-control" ng-model="charge">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="button" class="btn btn-success" id="myBtn"
                                    ng-click="medical_charges_entry()">Submit</button> &nbsp;
                        ...
                        <div class="container" style="padding-bottom: 20px !important;">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" data-dismiss="modal"
                                    ng-click="medical_charges_update()">Update</button>
                            </div>
