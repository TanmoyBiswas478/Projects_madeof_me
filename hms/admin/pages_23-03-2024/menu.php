...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
        ...
        <div style="padding-top: 20px;" ng-init="menueview()">
            ...
            <div class="container">
                <p class="text-right">
                    <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"><i
                            class="fa-solid fa-plus"></i> Add Menue</button>
                </p>
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr class="table-warning text-dark">
                            <th class="text-center">#</th>
                            <th class="text-center" style=" text-transform: uppercase;">Primary Menue Name</th>
                            <th class="text-center" style=" text-transform: uppercase;">Sub Menue Name</th>
                            <th class="text-center" style=" text-transform: uppercase;">Action</th>
                        </tr>
                    </thead>

                    <tbody>
                        <tr ng-repeat="x in menue_data">
                            <td class="text-center">{{$index+1}}</td>
                            <td class="text-center" style="text-transform: capitalize;">{{x.menue}}</td>
                            <td class="text-center" style="text-transform: capitalize;">{{x.submenu}}</td>

                            <td class="text-center">
                                <button class="btn-success" title="email" data-toggle="modal"
                                    data-target="#exampleModalCenter" ng-click="menue_edit(x.id)"><i class="fa-solid fa-pen-to-square" ></i></button>
                                <button class="btn-danger" title="Delete" ng-click="menue_delete(x.id)"><i
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" data-dismiss="modal" ng-click="menue_update()">Update</button>
        </div>
      </div>
    </div>
  </div>
