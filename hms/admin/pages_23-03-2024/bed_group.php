...
<body>
    <div ng-app="myApp" ng-controller="personCtrl">
        ...
        <!-- <h2 class="text-center"><u>Add Bed Section</u></h2> -->
        <div class="container" ng-init="bed_g_view();floor_view();">
            <p class="text-right">
                <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"><i
                        class="fa-solid fa-plus"></i> Add Bed</button>
            </p>
            <table class="table table-bordered table-striped">
                <thead>
                    <tr class="table-warning text-dark">
                        ...
                        <th class="text-center" style=" text-transform: uppercase;">Floor Number</th>
                        <th class="text-center" style=" text-transform: uppercase;">Descryption</th>
                        <th class="text-center" style=" text-transform: uppercase;">Action</th>
                    </tr>
                </thead>

                <tbody>
                    <tr ng-repeat="x in bed_g_data">
                        <td class="text-center">{{$index+1}}</td>
                        <td class="text-center">{{x.group_name}}</td>
                        <td class="text-center">{{x.floor}}</td>
                        <td class="text-center">{{x.descs}}</td>
                        <td class="text-center">
                            <button class="btn-success" title="Edit" data-toggle="modal"
                                data-target="#exampleModalCenter" ng-click="bed_g_edit(x.id)"><i
                                    class="fa-solid fa-pen-to-square"></i></button>
                            <button class="btn-danger" title="Delete" ng-click="bed_g_delete(x.id)"><i
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <h2 class="text-center">Bed Group Section</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" ng-model="floor">
                                        <option ng-repeat="y in floor_view_data">{{y.name}}</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="button" class="btn btn-success" id="myBtn"
                                    ng-click="bed_g_entry()">Submit</button> &nbsp;
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-dismiss="modal"
                        ng-click="role_update()">Update</button>
                </div>
            </div>
        </div>
    </div>
