                ...
                <div class="col-md-3 d-flex justify-content-center" style="text-align: justify !important;">
                        <div class="card" style="border-radius: 15px !important; box-shadow: 0 0 0.25em rgba(67,71,85,.27), 0 0.25em 1em rgba(90,125,188,.05) !important;  padding: 3%;  width: 100%; ">
                            <div class="card-body" style="height: 170px !important;">
                                <h5 class="card-title text-primary">Approval Pending</h5>
                                <p class="float-left text-primary" style="font-size:50px !important;">
                                <i class="fa-solid fa-person-chalkboard"></i>
                                </p>
                                <h1 class="float-right text-primary" style="font-size:50px !important;"><?php echo "0"; ?></h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card" style="border-radius: 15px !important; box-shadow: 0 0 0.25em rgba(67,71,85,.27), 0 0.25em 1em rgba(90,125,188,.05) !important;  padding: 3%;  width: 100%; ">
                            <div class="card-body" style="height: 170px !important;">
                                <h5 class="card-title text-success">Total Batch</h5>
                                <p class="float-left text-success" style="font-size:50px !important;"><i class="fa-solid fa-graduation-cap"></i></p>
                    ...
                    <div class="col-md-3">
                        <div class="card" style="border-radius: 15px !important; box-shadow: 0 0 0.25em rgba(67,71,85,.27), 0 0.25em 1em rgba(90,125,188,.05) !important;  padding: 3%;  width: 100%; ">
                            <div class="card-body" style="height: 170px !important;">
                                <h5 class="card-title text-warning">Complete Batch</h5>
                                <p class="float-left text-warning" style="font-size:50px !important;"><i class="fa-solid fa-user-graduate"></i></p>
                    ...
                    <div class="col-md-3">
                        <div class="card" style="border-radius: 15px !important; box-shadow: 0 0 0.25em rgba(67,71,85,.27), 0 0.25em 1em rgba(90,125,188,.05) !important;  padding: 3%;  width: 100%; ">
                            <div class="card-body" style="height: 170px !important;">
                                <h5 class="card-title text-danger">Ongoing Batch</h5>
                                <p class="float-left text-danger" style="font-size:50px !important;"><i class="fa-solid fa-book-open-reader"></i></p>
                    ...
                    <div class="col-md-6">
                        <div class="card" style="height: 500px !important; border-radius: 15px !important; box-shadow: 0 0 0.25em rgba(67,71,85,.27), 0 0.25em 1em rgba(90,125,188,.05) !important;  padding: 3%;  width: 100%;">
                            <div class="card-body"><br>
                             <h3> <i class="fa-solid fa-bell"></i> Notification Board</h3>
                            </div>
                        </div>
                    </div>
                </div>
