<br>
<div class="container" style="background: #fff; height: 500px !important; border: 2px solid #EAEAEC;"
    ng-init="roleview();staff_view();location_view();">
    <div class="row">
        <div class="col-md-12"
            style="background:blueviolet; height: 60px; color: #fff !important; display: flex; align-items: center;">
            <div class="mr-auto p-3"><i class="fa-solid fa-bars"></i> Staff Section</div>
            <div class="p-2">
                <button class="btn btn-success" data-toggle="modal" data-target=".bd-example-modal-lg1"
                    data-whatever="@mdo">
                    ...
                    <tr ng-repeat="x in staff_data">
                        ...
                        <td class="text-center">
                            <button class="btn-success" title="edit" data-toggle="modal"
                                data-target="#exampleModalCenter1"><i class="fa-solid fa-pen-to-square"
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="formGroupExampleInput" style="text-transform: capitalize;"
                                ng-model="gender">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <datalist id="jl">
                                <option ng-repeat="x in location">
                                    {{x.location}}
                                </option>
                            </datalist>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button type="button" class="btn btn-success" id="myBtn"
                            ng-click="staff_entry()">Submit</button>
                        &nbsp;
...
<div class="modal fade bd-example-modal-lg1" id="exampleModalCenter1" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="formGroupExampleInput">Gender</label>
                            <input type="text" list="gen" class="form-control" style="text-transform: capitalize;"
                                ng-model="gender">
                            <datalist id="gen">
                                <option>Male</option>
                                <option>Female</option>
