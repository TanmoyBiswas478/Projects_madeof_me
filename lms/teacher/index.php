...
<title>LMS Portal</title>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background: #774081 !important;">
    <a class="navbar-brand" href="#" style="color: #fff !important;">Teacher Dashboard</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
              <a class="nav-link" style="color: #fff !important;" href=""><i class="fa-solid fa-unlock"></i> Student Attendence</a>
         </li>
        ...
        <!-- <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="" id="navbarDropdown" role="a" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #fff !important;">
              <i class="fa-solid fa-person-chalkboard"></i> Training Section
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="#!/assign"><i class="fa-solid fa-angles-right"></i> Upload Assignment</a>
                <div class="dropdown-divider"></div>
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/link"><i class="fa-solid fa-angles-right"></i> Upload Online Class Link</a>
              </div>
          </li> 
          ...
          <i class="fa-solid fa-chalkboard-user"></i> Examination Section
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="#!/assingment_marks"><i class="fa-solid fa-angles-right"></i> Upload Assignment Marks</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/marks_statement"><i class="fa-solid fa-angles-right"></i> View Marks Statement</a>
              </div>
          </li> 
          ...
          <a class="nav-link dropdown-toggle" href="" id="navbarDropdown" role="a href=" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #fff !important;">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <div class="dropdown-divider"></div> -->
                <a class="dropdown-item" href="#!/class"><i class="fa-solid fa-angles-right"></i> View Class Schedule </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/batch_details"><i class="fa-solid fa-angles-right"></i> Batch Wise Details</a>
              </div>
          </li> 

          
          <li class="nav-item">
              <a class="nav-link" style="color: #fff !important;" href="#!/change_pass"><i class="fa-solid fa-unlock"></i> Change Password</a>
         </li>
