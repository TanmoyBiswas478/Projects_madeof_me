...
{
 $sql="SELECT r.id,t.tname,r.cname,r.fname,r.fees,r.tmode,r.doe,r.img,r.receipt FROM training t, registration r WHERE r.tname=t.sform and r.status='Pending'";
