                ...
                <div class="col-md-3 d-flex justify-content-center" style="text-align: justify !important;">
                        <div class="card" style="border-radius: 15px !important; box-shadow: 0 0 0.25em rgba(67,71,85,.27), 0 0.25em 1em rgba(90,125,188,.05) !important;  padding: 3%;  width: 100%; ">
                            <div class="card-body" style="height: 170px !important;">
                                <h5 class="card-title text-primary">Course Register</h5>
                    ...
                    <div class="col-md-3">
                        <div class="card" style="border-radius: 15px !important; box-shadow: 0 0 0.25em rgba(67,71,85,.27), 0 0.25em 1em rgba(90,125,188,.05) !important;  padding: 3%;  width: 100%; ">
                            <div class="card-body" style="height: 170px !important;">
                                <h5 class="card-title text-success">Course Complete</h5>
                    ...
                    <div class="col-md-3">
                        <div class="card" style="border-radius: 15px !important; box-shadow: 0 0 0.25em rgba(67,71,85,.27), 0 0.25em 1em rgba(90,125,188,.05) !important;  padding: 3%;  width: 100%; ">
                            <div class="card-body" style="height: 170px !important;">
                                <h5 class="card-title text-warning">Pending Fees</h5>
                                <p class="float-left text-warning" style="font-size:50px !important;"><i class="fa-solid fa-indian-rupee-sign"></i></p>
                    ...
                    <div class="col-md-3">
                        <div class="card" style="border-radius: 15px !important; box-shadow: 0 0 0.25em rgba(67,71,85,.27), 0 0.25em 1em rgba(90,125,188,.05) !important;  padding: 3%;  width: 100%; ">
                            <div class="card-body" style="height: 170px !important;">
                                <h5 class="card-title text-danger">Performance</h5>
