        ...
        <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="college" name="college" placeholder="Enter your College Id" class="form-control input-md" type="text" required>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Developers From Software World</span></h4>
        </div>
        ...
        <div class="modal-body">
          <p>
            <div class="row" >
              <div class="col-md-12">
                <h3 >Tanmoy Biswas<br /><br />
                  Bikram Deb<br/><br/>Ashneer Roy
                </h3>
              </div>
