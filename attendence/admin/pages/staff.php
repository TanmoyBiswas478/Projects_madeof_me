                    ...
                    <div class="d-flex">
                        ...
                        <div class="p-2">
                            <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"
                                ng-click="roleview();outletview();"><i class="fa-solid fa-plus"></i> Add Staff</button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <table width="100%" class="table table-bordered" style="font-size: 11.5px!important;">
                        ...
                        <tbody>
                            <tr ng-repeat="x in staff_data">
                                ...
                                <td class="text-center">{{x.cid}}</td>
                                <td class="text-center">{{x.name | uppercase}}</td>
                                ...
                                <td class="text-center">
                                    <button class="btn-success" title="edit" data-toggle="modal"
                                        data-target="#exampleModalCenter"><i class="fa-solid fa-pen-to-square"
                                            ng-click="staff_edit(x.id)"></i></button>
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form method="post" action="../assets/api/staff_entry.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" ng-model="phone" name="phone" maxlength="10"
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                            ng-blur="check()" required>
                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExampleInput"
                                            style="text-transform: uppercase;" ng-model="sname" name="sname" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" style="text-transform: capitalize;"
                                            ng-model="address" name="address" required></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="formGroupExampleInput"
                                            style="text-transform: capitalize;" ng-model="gender" name="gender" required>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExampleInput"
                                            style="text-transform: lowercase;" ng-model="email" name="email">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" ng-model="role" name="role">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" ng-model="location" name="location"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExampleInput"
                                            style="text-transform: capitalize;" ng-model="quali" name="quali">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Phone No</label>
                                        <input type="text" class="form-control" ng-model="phone" maxlength="10"
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                            ng-blur="check()" required>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Staff Name</label>
                                        <input type="text" class="form-control" id="formGroupExampleInput"
                                            style="text-transform: uppercase;" ng-model="sname">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Gender</label>
                                        <input type="text" list="gen" class="form-control"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Email</label>
                                        <input type="text" class="form-control" id="formGroupExampleInput"
                                            style="text-transform: lowercase;" ng-model="email">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Job Location</label>
                                        <input type="text" list="jl" class="custom-select" ng-model="location"
                                            style="text-transform: capitalize;">
                                        <datalist id="jl">
                                            <option ng-repeat="x in sdata">
                                                {{x.oname}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Qualification</label>
                                        <input type="text" class="form-control" id="formGroupExampleInput"
                                            style="text-transform: capitalize;" ng-model="quali">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" data-dismiss="modal"
                                ng-click="staff_update()">Update</button>
                        </div>
                    </div>
                </div>
            </div>