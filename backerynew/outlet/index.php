        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <i class="fas fa-people-arrows"></i> Transaction Section
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="#!/order"><i class="fas fa-angle-double-right"></i> Order Received</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/oview"><i class="fas fa-angle-double-right"></i> Order Delivery</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/rs"><i class="fas fa-angle-double-right"></i> Requsition Submit</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/rr"><i class="fas fa-angle-double-right"></i> Requsition Received</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/bill"><i class="fas fa-angle-double-right"></i> Bill Section</a>
                <!-- <div class="dropdown-divider"></div>
            ...
            <!-- <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/ref"><i class="fas fa-angle-double-right"></i> Vendore Payment</a>
              </div>
            </li> -->
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/rreport"><i class="fas fa-angle-double-right"></i> Requsition Report </a>
                <!-- <div class="dropdown-divider"></div>
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/pr"><i class="fas fa-angle-double-right"></i> Product Report</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#!/oreport"><i class="fas fa-angle-double-right"></i> Order Report</a>
              </div>
            </li>
