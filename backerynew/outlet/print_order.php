...
<body>
  ...
  <div style="display: flex; padding-bottom: 5px;">
    <div style="flex: 3;"><b>Del Date:</b></div>
    <div style="flex: 2;"><?php echo "22-05-2024"; ?></div>
    <div style="flex: 1;"><b>Del Time</b></div>
    <div style="flex: 3;"><?php echo "7:00 PM";?></div>
  </div>

  <div style="display: flex; padding-bottom: 5px;">
    <div style="flex: 3;"><b>Cake Flavour:</b></div>
    <div style="flex: 2;"><?php echo "Vanilla"; ?></div>
    <div style="flex: 1;"><b>Shape</b></div>
    <div style="flex: 3;"><?php echo "Heart";?></div>
  </div>
    ...
    <table>
      ...
      <tbody>
          <tr>
            ...
            <td style="text-align: center;">Vanila Cake</td>
            <td style="text-align: center;">500 Grm</td>
          ...
          <tr>
            ...
            <td style="text-align: center;">Balon Pkt</td>
            <td style="text-align: center;">1 pkt</td>
          ...
          <tr>
            ...
            <td style="text-align: center;">2 pak</td>
      ...
      <tfoot>
        <tr>
          ...
          <td style="text-align:right;">&#8377;<?php echo "590.00";?></td>
        </tr>
        <tr>
 ...
 <table>
      ...
      <tr>
          ...
          <td style="text-align:right;" id="totalAmount">&#8377;<?php echo "590";?>.00</td>
      </tr>
      
      <tr>
          <td colspan="4">Advance Paid</td>
          <td style="text-align:right;">&#8377;<?php echo "300";?>.00</td>
      </tr>

      <tr>
          <td colspan="4">Balance Dues:</td>
          <td style="text-align:right;">&#8377;<?php echo "290";?>.00</td>
      </tr>
      <tr>
