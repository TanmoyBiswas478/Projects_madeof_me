...
else if($op=='edit')
{
 ...
 $where = "id =".$data1['id'];
 unset($data1['idd']);
 $obj->update_db('category', $data1,$where);
}
...
else if($op=='select_condition')
{
 ...
 $where = "id =".$data1['idd'];
 unset($data1['idd']);
 $obj->select_db('category', $data1,$where);
}
?>