...
?>
<br>
<div class="container-fluid" style="background: #fff; border: 2px solid #EAEAEC;" ng-init="material_view1();trainingview();">
    <!-- Header Section -->
    <div class="row">
        <div class="col-md-12"
            style="background: blueviolet; height: 60px; color: #fff; display: flex; align-items: center;">
    ...
    <div class="row" style="padding-top: 10px;">
        <div class="col-md-12">
            <div class="form-group">
                <label for="trainingSelect">Training Name</label>
